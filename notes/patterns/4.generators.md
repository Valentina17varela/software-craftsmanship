...
A generator can expose backtracking solutions one at a time:
...
Use generators for large streams, pipelines, tree traversals, combinatorial results, and early termination when only part of the output may be consumed.
