...
Many range-sum or range-count queries over an array that does not change bring me back to prefix sums. If updates are involved, I consider a Fenwick tree or segment tree instead.
